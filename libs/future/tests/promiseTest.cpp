...
TEST_CLASS_EX (PromiseTest, LibletAwareMemLeakDetection)
{
  ...
  TEST_METHOD(Promise_SetValue_Empty)
  {
    Mso::Promise<int> p1(nullptr);
    TestCheckCrash(p1.SetValue(5));
  }

  TEST_METHOD(Promise_SetValue_AlreadySet)
  {
    Mso::Promise<int> p1;
    p1.SetValue(5);
    TestCheckCrash(p1.SetValue(5));
  ...
  TEST_METHOD(Promise_SetValue_AlreadyCanceled)
  {
    Mso::Promise<int> p1;
  ...
  TEST_METHOD(Promise_TrySetValue_Empty)
  {
    Mso::Promise<int> p1(nullptr);
  ...
  TEST_METHOD(Promise_EmplaceValue_Empty)
  {
    Mso::Promise<int> p1(nullptr);
    TestCheckCrash(p1.EmplaceValue(5));
  }

  TEST_METHOD(Promise_EmplaceValue_AlreadySet)
  {
    Mso::Promise<int> p1;
    p1.EmplaceValue(5);
    TestCheckCrash(p1.EmplaceValue(5));
  ...
  TEST_METHOD(Promise_EmplaceValue_AlreadyCanceled)
  {
    Mso::Promise<int> p1;
    TestCheck(p1.TryCancel());
    TestCheckCrash(p1.EmplaceValue(5));
  ...
  TEST_METHOD(Promise_TryEmplaceValue_Empty)
  {
    Mso::Promise<int> p1(nullptr);
  ...
  TEST_METHOD(Promise_TryCancel_Empty)
  {
    Mso::Promise<int> p1(nullptr);
  ...
  TEST_METHOD(PromiseVoid_SetValue_Empty)
  {
    Mso::Promise<void> p1(nullptr);
    TestCheckCrash(p1.SetValue());
  }

  TEST_METHOD(PromiseVoid_SetValue_AlreadySet)
  {
    Mso::Promise<void> p1;
    p1.SetValue();
    TestCheckCrash(p1.SetValue());
  ...
  TEST_METHOD(PromiseVoid_SetValue_AlreadyCanceled)
  {
    Mso::Promise<void> p1;
    TestCheck(p1.TryCancel());
    TestCheckCrash(p1.SetValue());
  ...
  TEST_METHOD(PromiseVoid_TrySetValue_Empty)
  {
    Mso::Promise<void> p1(nullptr);
  ...
  TEST_METHOD(PromiseVoid_TryCancel_Empty)
  {
    Mso::Promise<void> p1(nullptr);
    TestCheckCrash(p1.TryCancel());
  }
