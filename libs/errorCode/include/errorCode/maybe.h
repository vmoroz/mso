...
Maybe<T>::Maybe(const Maybe& other) noexcept : m_kind(other.m_kind)
{
  switch (other.m_kind)
  {
    case MaybeKind::Value: ::new (reinterpret_cast<T*>(&reinterpret_cast<char&>(m_value))) T(other.m_value); break;
    case MaybeKind::Error: ::new (&m_error) Mso::ErrorCode(other.m_error); break;
  }
}
...
Maybe<T>::Maybe(Maybe&& other) noexcept : m_kind(other.m_kind)
{
  switch (other.m_kind)
  {
    case MaybeKind::Value:
      ...
      break;
    case MaybeKind::Error: ::new (&m_error) Mso::ErrorCode(std::move(other.m_error)); break;
  }
}
...
#pragma warning(suppress : 4583) //  destructor is not implicitly called
{
  switch (m_kind)
  {
    case MaybeKind::Value: (reinterpret_cast<T*>(&reinterpret_cast<char&>(m_value)))->~T(); break;
