...
#pragma once
  ...
  */
  ...
  #define AssertSz2Tag(f, sz, a, b, tag) \
    AssertSzNTagImpl(f, InlineMsoAssertParams(#f, tag, __FILE__, __LINE__), sz, a, b)
    ...
    MsoAssertSzTagProcInline(MsoAssertParamsType params, _Printf_format_string_ const char* szFmt, ...) MSONOEXCEPT
{
  ...
  */
  ...
  #define AssertDoSz5Tag(f, sz, a, b, c, d, e, tag) \
    Statement(if ((f) == 0) { AssertSz5Tag(0, sz, a, b, c, d, e, tag); })
