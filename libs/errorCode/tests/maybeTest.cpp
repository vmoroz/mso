...
TEST_CLASS (MaybeTest) {
  ...
  TEST_METHOD(Maybe_GetValueCrash) {
    Mso::Maybe<int> m1(MyErrorProvider().MakeErrorCode(MyData(1, 4)));
  ...
  TEST_METHOD(Maybe_TakeValueCrash) {
    Mso::Maybe<int> m1(MyErrorProvider().MakeErrorCode(MyData(1, 4)));
  ...
  TEST_METHOD(Maybe_GetErrorCrash) {
    Mso::Maybe<MyData> m1{Mso::InPlaceTag(), 1, 2};
  ...
  TEST_METHOD(Maybe_GetTakeCrash) {
    Mso::Maybe<MyData> m1{Mso::InPlaceTag(), 1, 2};
  ...
  TEST_METHOD(MaybeVoid_GetErrorCrash) {
    Mso::Maybe<void> m1;
  ...
  TEST_METHOD(MaybeVoid_GetTakeCrash) {
    Mso::Maybe<void> m1;
